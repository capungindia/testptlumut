            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('post.update') }}">
                        ...
                        <input id="idpost" type="hidden" name="idpost" value="{{ $post->idpost }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="content" type="text" class="form-control @error('content') is-invalid @enderror" name="content" value="{{ $post->content }}" required>
